...
const NOTION = {
  ...
  digitalKorsou: "https://app.notion.com/p/2eaa269fc947803c8518e3b023a10cb8",
  ...
  piska: "https://app.notion.com/p/c86a269fc94782199824815f9ca88635",
};
...
export const REGISTRY: RegistryProject[] = [
  ...
  { id:"ai-marketing-tools", name:"AI Marketing Tools", zone:"AI Business", portfolioStream:"AI Systems & GPT Products", assetType:"Product", status:"Repo", operatingStatus:"Incubator", visibility:"Public", description:"AI-powered marketing platform retained as a GPT Innovation child product while product readiness and live-runtime evidence are reconciled.", githubUrl:"https://github.com/sahidattaf/AI-Marketing-Tools-Agent", notionUrl:NOTION.gpti, relatedRepositories:["https://github.com/sahidattaf/ai_marketing_tools_agent"], category:"Marketing AI", stack:["React","React Native","Flask","AI"], owner:"Sahid Attaf", priority:"P2", revenuePotential:"SaaS", commercialStatus:"Pre-Revenue", evidenceStatus:"Partial", parentProject:"gpt-innovation-os", nextDecision:"Confirm current supported runtime and product-readiness evidence before any client-facing use", nextAction:"Treat AI-Marketing-Tools-Agent as canonical and the underscore repository as related legacy evidence pending a separate repository-cleanup decision", lastReviewed:"2026-09-07", tags:["Marketing","AI","GPT Innovation"] },
  ...
  { id:"piska-ecosystem", name:"PISKA Ecosystem", zone:"Real Estate / Kai Korsou", portfolioStream:"Real Estate & Resort Developments", assetType:"Infrastructure", status:"Repo", operatingStatus:"Maintain", visibility:"Hybrid", description:"Supporting AI agent and SDK capability layer for the Kai Kòrsou/Piskadera development ecosystem; represented once in the executive registry rather than as separate ventures.", githubUrl:"https://github.com/sahidattaf/piska-gpts-ecosystem", notionUrl:NOTION.piska, relatedRepositories:["https://github.com/sahidattaf/piska-sdk"], category:"Development AI Infrastructure", stack:["AI Agents","SDK","GitHub","Notion"], owner:"Sahid Attaf", priority:"P2", revenuePotential:"Portfolio", commercialStatus:"Internal", evidenceStatus:"Partial", parentProject:"kai-korsou-waterfront", nextDecision:"Keep legacy Piskadera and Jack Evertzberg repositories as evidence until a separately gated cleanup decision", nextAction:"Maintain one canonical PISKA ecosystem asset and reconcile supporting components without deleting or archiving legacy repositories", lastReviewed:"2026-09-07", tags:["PISKA","Kai Kòrsou","Agents","Infrastructure"] },
  ...
  { id:"digital-korsou", name:"Digital Kòrsou — Boske di AI", zone:"Digital & Education", portfolioStream:"Digital Platforms & Education", assetType:"Venture", status:"Prototype", operatingStatus:"Pilot", visibility:"Public", description:"Controlled AI education and workforce/community pilot program.", githubUrl:"https://github.com/sahidattaf/digital-korsou-boske-ai", notionUrl:NOTION.digitalKorsou, category:"AI Education", stack:["GitHub","Notion","AI Education"], owner:"Sahid Attaf", priority:"P1", revenuePotential:"Platform", commercialStatus:"Pilot", evidenceStatus:"Partial", ownerGate:"DK-IMPACTO-SEND", nextAction:"Prepare the September pilot while preserving partner and publication gates", lastReviewed:"2026-09-07", tags:["Education","Curaçao","AI"] },
  ...
  { id:"sahid-ai-hub", name:"Sahid AI Hub", zone:"Infrastructure", portfolioStream:"Portfolio Infrastructure", assetType:"Infrastructure", status:"Live", operatingStatus:"Active Infrastructure", visibility:"Public", description:"Technical portfolio registry and dashboard connecting projects, repositories, deployments and evidence routing.", githubUrl:"https://github.com/sahidattaf/sahid-ai-hub", vercelProject:"sahid-ai-hub", category:"Portfolio Infrastructure", stack:["Next.js 16","TypeScript","Tailwind CSS v4","Vercel"], owner:"Sahid Attaf", priority:"P1", revenuePotential:"Portfolio", commercialStatus:"Internal", evidenceStatus:"Verified", nextAction:"Maintain Registry v2.1 accuracy, reconcile evidence gaps, and keep portfolio routing aligned to owner-approved project states", lastReviewed:"2026-09-07", tags:["Portfolio","Registry","Infrastructure"] },
...
export function validateRegistry(projects: RegistryProject[] = REGISTRY): string[] {
  ...
  for (const project of projects) {
    ...
    for (const relatedRepository of project.relatedRepositories ?? []) if (!isHttpUrl(relatedRepository)) errors.push(`${project.id}: invalid relatedRepositories URL`);
